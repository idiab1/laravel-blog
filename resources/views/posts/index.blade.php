                        ...
                        <tbody>
                            ...
                            @foreach ($posts as $post)
                                <tr>
                                    ...
                                    <td>
                                        <a class="text-success" href="{{route('post.show', ['post' => $post->slug])}}"> <i class="fas fa-eye"></i></a>
                                        <a class="text-primary px-2" href="{{route('post.edit', ['post' => $post->id])}}"> <i class="fas fa-edit"></i></a>
